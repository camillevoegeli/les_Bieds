...
CHECK: pour NEE, vérifier les flux 10 11 12, possible ébullition ? Ou peut-être 
que l'effet positif de la lumière sur l'oxidation ch4 n'est pas valable sur les 
site immergés
...
```
Comme attendu, diminution des émissions à la lumière pour 10, effet inverse pour
11 -> CHECK VALUES
